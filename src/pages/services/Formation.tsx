          ...
          <Tabs value={activeTab} onValueChange={handleTabChange}>
            ...
            <TabsContent value="categories" className="space-y-16">
              ...
              <div className="bg-blue-50/50 p-8 rounded-xl border border-blue-100">
                <SectionTitle title={<h2 className="text-2xl font-bold text-orange-500 flex items-center gap-2 mx-[240px] px-[42px]">
              ...
              <div className="bg-green-50/50 p-8 rounded-xl border border-green-100">
                <SectionTitle title={<h2 className="text-2xl font-bold text-orange-500 flex items-center gap-2 py-0 mx-[240px] px-[78px]">
                      <Briefcase className="h-7 w-7" />
                      Compétences RH
                    </h2>} subtitle="Développez vos compétences en gestion des ressources humaines" />
                
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-8 my-0 px-[240px] mx-[80px]">
